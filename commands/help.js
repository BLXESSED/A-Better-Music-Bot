module.exports = {
    ...
    async execute(message, args, cmd, client, Discord){
        ...
        .addFields(
            {name: '<a:musicbeat:835354164782694440> **Music**', value: "[Click Here](https://abettermusicbot.cf/commands/)"},
            {name: '<a:gearSpinning:835354164547813396> **Utilities**', value: "[Click Here](https://abettermusicbot.cf/commands/)"},
